...
def refine_detections_graph(rois, probs, deltas, window, config):
    ...
    detections = tf.concat([
        ...
        tf.gather(probs, keep) ## add probs as output
        ], axis=1)
...
class MaskRCNN():
    ...
    def unmold_detections(self, detections, mrcnn_mask, original_image_shape,
        ...
        if exclude_ix.shape[0] > 0:
            ...
            dist = np.delete(dist, exclude_ix, axis=0)
        ...
        return boxes, class_ids, scores, full_masks, dist
    ...
    def detect(self, images, verbose=0):
        ...
        detections, mrcnn_class, mrcnn_box, mrcnn_mask, _, rpn_class, _ =\
            self.keras_model.predict([molded_images, image_metas, anchors], verbose=0)
        # Process detections

        results = []
        for i, image in enumerate(images):
            final_rois, final_class_ids, final_scores, final_masks, final_dist=\
